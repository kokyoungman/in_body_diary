...
let arrows = [];
arrows.push(document.querySelector(".js-arrow-0"));
arrows.push(document.querySelector(".js-arrow-1"));
arrows.push(document.querySelector(".js-arrow-2"));
arrows.push(document.querySelector(".js-arrow-3"));
arrows.push(document.querySelector(".js-arrow-4"));
arrows.push(document.querySelector(".js-arrow-5"));
arrows.push(document.querySelector(".js-arrow-6"));
let numbers = [];
let partNumbers = [];
